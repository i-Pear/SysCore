...
typedef struct _plic_target_enables {
  ...
  struct {
    uint32_t enable[32 * 2]; /* Offset 0x00-0x7C: Bit 0 is zero, Bits 1-1023 is
                                bits*/
  } target[15872 / 2];
...
//  *
//  * @note        This function will set MIP_MEIP. The MSTATUS_MIE must set by
//  * user.
//  *
//  * @return      result
//  *     - 0      Success
...
//  *              plic_instance_t (*plic_instance)[IRQN_MAX] =
//  * plic_get_instance();
//  *              ... plic_instance[x][y] ...;
//  *
